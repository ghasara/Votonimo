    ...
    <body>
        ...
        <main class="feed_detail1">
            <section class="photo_detail1o">
                <div class="btn-group">
                    <a href="save-listing.php"><button style="font-weight:700;background-color:#000000;color:#ffffff">Listings</button></a>
                    <a href="save-listing1.php"><button style="font-weight:700;">Products</button></a>
                </div>
                <div class="photo_11">
