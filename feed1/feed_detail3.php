            ...
            <section class="photo_detail1">
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1" style="font-size:large">3 Best Jackets</p>
                    </div>
                </header>
            </section>
            <section class="photo_detail1">
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1">Popular Jacket</p>
                    </div>
                </header>
                <div class="photo__file-contain_detail1">
                    <a href="#"><img class="photo__file_detail1" src="..\images\jacket.jpg"></a>
                </div>
            ...
            <section class="photo_detail1o">
                <div class="photo__user">Similiar products:</div>
                    <header class="photo__header_detail1o">
                        <a href="feed_detail1.php"><img class="photo__avatar_detail1o" src="..\images\first.jpg"></a>
                        <span class="photo__usernameo">Denim&nbsp;Jacket</span>
                        <span class="photo__usernameoo fa fa-vimeo" style="color:rgb(0, 0, 0)"></span>
                ...
                <header class="photo__header_detail1o">
                    <a href="feed_detail2.php"><img class="photo__avatar_detail1o" src="..\images\first1.jpg"></a>
                    <span class="photo__usernameo">Black&nbsp;Jacket</span>
                ...
                <header class="photo__header_detail1o" style="background-color:antiquewhite">
                    <a href="feed_detail3.php"><img class="photo__avatar_detail1o" src="..\images\jacket.jpg"></a>
                    <span class="photo__usernameo">Popular&nbsp;Jacket</span>
                    <span class="photo__usernameoo fa fa-vimeo"></span>
                    <span class="photo__usernameooo">This is area of product description where products provide their info.</span>
                    <i class="">37%</i>
                ...
                <!--<header class="photo__header_detail1o">
                    <a href="feed_detail4.php"><img class="photo__avatar_detail1o" src="..\images\shoes.jpg"></a>
                    <span class="photo__usernameo">Popular&nbsp;Shoes</span>
                    <span class="photo__usernameoo fa fa-vimeo"></span>
                    <span class="photo__usernameooo">This is area of product description where products provide their info.</span>
                    <i class="">50%</i>
                    <i style="font-weight:500;"> 50%</i>
