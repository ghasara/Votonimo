        ...
        <main class="feed_detail1">
            ...
            <div class="tab-pane fade in active photo_detail1" id="one">
                ...
                <div class="photo__file-contain_detail1">
                    <a href="https://www.notino.co.uk/amouage/reflection-eau-de-parfum-for-men/"><img class="photo__file_detail1" src="..\images\folder\image16.jpeg"></a>
                </div>
                <div class="photo__info">
                    <div class="photo__icons" style="position:relative;">
                        <span class="photo__icon" style="right:0;position:absolute;">
                            <a href="https://www.notino.co.uk/amouage/reflection-eau-de-parfum-for-men/"><i class="fa fa-credit-card" style="font-size:25px;color:black"></i></a>
                        </span>
                    </div>
                </div>
                </div>
            ...
            <section class="photo_detail1o">
                ...
                <ul class="nav">
            <li class="active"><a data-toggle="tab" href="#one" style="color:black">
                    <header class="photo__header_detail12345" >
                    <a data-toggle="tab" href="#one" style="color:black"><img class="photo__avatar_detail12345" src="..\images\folder\image16.jpeg"></a>
                    <span class="photo__usernameo2"><a href="https://www.notino.co.uk/amouage/reflection-eau-de-parfum-for-men/" style="color:black;">Amouage&nbsp;Reflection&nbsp;Man</a></span>
