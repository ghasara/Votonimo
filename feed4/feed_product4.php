    ...
    and (max-width: 1300px){
        ...
        <main class="feed_detail1">
            <section class="photo_detail1">
                <a href="feed_detail5.php"><img src="..\images\back2.png" style="color:black;width:17px;height:17px;margin:10px 0px 0px 10px;font-weight:300;font-size:larger"></a>
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1" style="font-size:large">Ronaldo Nazario</p>
                    </div>
                </header>
            </section>
            ...
            <div class="tab-pane fade in active photo_detail1" id="one">
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1">Brazil Home Retro replica</p>
                    </div>
                </header>
                <div class="photo__file-contain_detail1">
                    <a href="https://beautiful90s.com/products/2004-brazil-home-yellow-retro-replica-football-shirt?utm_medium=cpc&utm_source=google&utm_campaign=Google%20Shopping&gclid=Cj0KCQjw6ar4BRDnARIsAITGzlBnHO94l7j01_UmG94ApoJ7UBksaSeYepKXoB0crj1x-h6Ruo21AekaAgabEALw_wcB"><img class="photo__file_detail1" src="..\images\image21.jpg"></a>
                </div>
                <div class="photo__info">
                    <div class="photo__icons" style="position:relative;">
                        
                        <span class="photo__icon" style="right:0;position:absolute;">
                            <a href="https://beautiful90s.com/products/2004-brazil-home-yellow-retro-replica-football-shirt?utm_medium=cpc&utm_source=google&utm_campaign=Google%20Shopping&gclid=Cj0KCQjw6ar4BRDnARIsAITGzlBnHO94l7j01_UmG94ApoJ7UBksaSeYepKXoB0crj1x-h6Ruo21AekaAgabEALw_wcB"><i class="fa fa-credit-card" style="font-size:25px;color:black;"></i></a>
            ...
            <div class="photo_detail1 tab-pane fade" id="two" >
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1">Ronaldo Luis Nazario de Lima Legend T-shirt</p>
                    </div>
                </header>
                <div class="photo__file-contain_detail1">
                    <a href="https://www.amazon.co.uk/dp/B00P06NM8Q/ref=cm_sw_r_cp_api_i_oQWcFbW01P6WA"><img class="photo__file_detail1" src="..\images\image2.jpeg"></a>
                </div>
                <div class="photo__info">
                    <div class="photo__icons" style="position:relative;">
                        ...
                        <span class="photo__icon" style="right:0;position:absolute;">
                            ...
                            <a href="https://www.amazon.co.uk/dp/B00P06NM8Q/ref=cm_sw_r_cp_api_i_oQWcFbW01P6WA 
            ...
            <li class="active">
                    ...
                    <a data-toggle="tab" href="#one" style="color:black"><img class="photo__avatar_detail12345" src="..\images\image21.jpg"></a>
                    <span class="photo__usernameo2"><a href="https://beautiful90s.com/products/2004-brazil-home-yellow-retro-replica-football-shirt?utm_medium=cpc&utm_source=google&utm_campaign=Google%20Shopping&gclid=Cj0KCQjw6ar4BRDnARIsAITGzlBnHO94l7j01_UmG94ApoJ7UBksaSeYepKXoB0crj1x-h6Ruo21AekaAgabEALw_wcB" style="color:black;">Brazil&nbsp;Home&nbsp;Retro</a></span>
            ...
            <li>
                <header class="photo__header_detail12345">
                    <a data-toggle="tab" href="#two" style="color:black"><img class="photo__avatar_detail12345" src="..\images\image2.jpeg"></a>
                    <span class="photo__usernameo2"><a href="https://www.amazon.co.uk/dp/B00P06NM8Q/ref=cm_sw_r_cp_api_i_oQWcFbW01P6WA" style="color:black;">Ronaldo&nbsp;Luis&nbsp;Nazario</a></span>
                    <span class="photo__usernameoo2 fa fa-bookmark" style="color:rgb(0, 0, 0);font-size: 22px;font-weight:700"></span>
                    <span class="photo__usernameooo2">This is area of product description where products provide their info.</span>
                </header>
            </li>
