            ...
            <section class="profile">
                <header class="profile__header">
                    <div class="profile__avatar-container">
                        <img src="..\images\74.jpg" class="profile__avatar">
                    </div>
                    <div class="profile__info">
                        <div class="profile__name">
                            <h1 class="profile__title">Mr.john31</h1>
                        ...
                        <div class="profile__bio0">
                            <span class="profile__full-name u-fat-text">John Cage</span>
                            <p class="profile__full-bio">#musing</p>
                        </div>
                    </div>
                </header>
                <div class="photo_11">
