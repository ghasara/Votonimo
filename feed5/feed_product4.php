    ...
    and (max-width: 1300px){
        ...
        <main class="feed_detail1">
            ...
            <div class="tab-pane fade in active photo_detail1" id="one">
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1">YSL&nbsp;La&nbsp;Nuit&nbsp;De&nbsp;L'homme</p>
                    </div>
                </header>
                <div class="photo__file-contain_detail1">
                    <a href="https://www.notino.co.uk/yves-saint-laurent/la-nuit-de-lhomme-eau-de-toilette-for-men/"><img class="photo__file_detail1" src="..\images\folder\image14.jpeg"></a>
                </div>
                <div class="photo__info">
                    <div class="photo__icons" style="position:relative;">
                        <span class="photo__icon" style="right:0;position:absolute;">
                            <a href="https://www.notino.co.uk/yves-saint-laurent/la-nuit-de-lhomme-eau-de-toilette-for-men/"><i class="fa fa-credit-card" style="font-size:25px;color:black"></i></a>
                        </span>
                    </div>
                </div>
                </div>
            ...
            <li class="active">
                    ...
                    <a data-toggle="tab" href="#one" style="color:black"><img class="photo__avatar_detail12345" src="..\images\folder\image14.jpeg"></a>
                    <span class="photo__usernameo2"><a href="https://www.notino.co.uk/yves-saint-laurent/la-nuit-de-lhomme-eau-de-toilette-for-men/">YSL&nbsp;La&nbsp;Nuit&nbsp;De&nbsp;L'homme</a></span>
