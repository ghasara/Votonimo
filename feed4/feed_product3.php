    ...
    and (max-width: 1300px){
        ...
        <main class="feed_detail1">
            <section class="photo_detail1">
                <a href="feed_detail3.php"><img src="..\images\back2.png" style="color:black;width:17px;height:17px;margin:10px 0px 0px 10px;font-weight:300;font-size:larger"></a>
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1" style="font-size:large">Pele</p>
                    </div>
                </header>
            </section>
            ...
            <div class="tab-pane fade in active photo_detail1" id="one">
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1">Brasil 1970 World Cup Final shirt</p>
                    </div>
                </header>
                <div class="photo__file-contain_detail1">
                    <a href="https://www.3retro.com/international/national/national/457_Brasil-1970-World-Cup-Final-shirt.php"><img class="photo__file_detail1" src="..\images\image14.jpeg"></a>
                </div>
                <div class="photo__info">
                    <div class="photo__icons" style="position:relative;">
                        
                        <span class="photo__icon" style="right:0;position:absolute;">
                            <a href="https://www.3retro.com/international/national/national/457_Brasil-1970-World-Cup-Final-shirt.php"><i class="fa fa-credit-card" style="font-size:25px;color:black;"></i></a>
            ...
            <div class="photo_detail1 tab-pane fade" id="two" >
                ...
                <header class="photo__header1">
                    <div class="photo__header-column1">
                        <p class="photo__d1">Brazil Home shirt</p>
                    </div>
                </header>
                <div class="photo__file-contain_detail1">
                    <a href="https://www.uksoccershop.com/p-29429/2013-14-Brazil-Home-Shirt-(Zico-10).php"><img class="photo__file_detail1" src="..\images\image01.jpg"></a>
                </div>
                <div class="photo__info">
                    <div class="photo__icons" style="position:relative;">
                        ...
                        <span class="photo__icon" style="right:0;position:absolute;">
                            ...
                            <a href="https://www.uksoccershop.com/p-29429/2013-14-Brazil-Home-Shirt-(Zico-10).php
            ...
            <li class="active">
                    ...
                    <a data-toggle="tab" href="#one" style="color:black"><img class="photo__avatar_detail12345" src="..\images\image14.jpeg"></a>
                    <span class="photo__usernameo2"><a href="https://www.3retro.com/international/national/national/457_Brasil-1970-World-Cup-Final-shirt.php" style="color:black">Brasil&nbsp;1970&nbsp;World&nbsp;Cup</a></span>
            ...
            <li>
                <header class="photo__header_detail12345">
                    <a data-toggle="tab" href="#two" style="color:black"><img class="photo__avatar_detail12345" src="..\images\image01.jpg"></a>
                    <span class="photo__usernameo2"><a href="https://www.uksoccershop.com/p-29429/2013-14-Brazil-Home-Shirt-(Zico-10).php" style="color:black">Brazil&nbsp;Home&nbsp;shirt</a></span>
                    <span class="photo__usernameoo2 fa fa-bookmark" style="color:rgb(0, 0, 0);font-size: 22px;font-weight:700"></span>
                    <span class="photo__usernameooo2">This is area of product description where products provide their info.</span>
                </header>
            </li>
