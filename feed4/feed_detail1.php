            ...
            <section class="photo_detail1" id="one">
                ...
                <div class="photo__info">
                    ...
                    <ul id="comment_list" class="photo__comments">
                        ...
                        <?php $rute = mysqli_query($db, "SELECT * from comment");
                        while ($data = mysqli_fetch_assoc($rute)):  ?>
                            <li class="photo__comment">
                            <span class="photo__comment-author"><?php echo $data['username']; ?></span>
                            <span class="comment"><?php echo $data['comment']; ?></span>
                            <span class="photo__time-ago">1 minute ago</span>
                            </li>
                        <?php endwhile; ?>
                    </ul>
                    <div class="login__div"><a href="#" style="color:#999;">Comments</a></div>
                    <form action="" method="post">
                    <div class="photo__add-comment-container" style="display:flex;">
                        <textarea id="myInput" name="myinput" placeholder="Add a comment..." class="photo__add-comment"></textarea>
                        <button type="submit" name="comment" class="fa fa-arrow-right" style="position:relative!important;margin-bottom:10px;"></button>
                    </div>
                    </form>
                </div>
            </section>
